...
# EMPREGA
# python recognize_video_meu.py --conf config/config.json
...
# EXECUTAMOS CADA ETAPA SOBRE CADA FRAME DO VIDEO
# inicializamos a camara e esperamos un pouco para quentar o sensor
print("[INFO] Iniciamos a camara de video...")
